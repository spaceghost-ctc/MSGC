...
void updateScreen() {
  ...
  switch(displayMode) {
    ...
    case 2:
    updateScreen2(); break;
    default: Serial.println("You messed up your display modes somehow");
  }
  display.display();
}
...
void updateScreen0() {
  ...
  if (seconds < 10) {
    ...
    display.print((String)seconds);
  }
  //SNR
  display.print(" SNR:");
  display.println(rf95.lastSNR());
  //display date
  display.println("Date: " + (String)day + '/' + (String)month + "/20" + (String)year);
  //display fix/quality
  display.print("F: " + (String)fix + " Q: " + (String)fixquality + " S: " + (String)satellites);
}

void updateScreen1() {
  //Lat, Lon, Speed, Angle, Altitude
  display.println("Lat: " + (String)latitude + lat);
  display.println("Lon: " + (String)longitude + lon);
  display.println("S:" + (String)spd + ", A:" + (String)angle);
  display.println("Altitude: " + (String)altitude);
}

void updateScreen2() {
  //OWT, AT, RBT, Acceleration
  display.println("OWT: " + (String)OWT + " C");
  display.println("AT: " + (String)AT + " C");
  display.println("RBT: " + (String)RBT + " C");
  display.print("XYZ:");
  display.print(X, 1);
  display.print(" ");
  display.print(Y, 1);
